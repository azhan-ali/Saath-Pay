...
export default function HowItWorks() {
  return (
    <section id="how" className="py-24 px-4 relative bg-paper-dark/40">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <motion.p
            ...
            viewport={{ once: true }}
            className="font-[family-name:var(--font-hand)] text-2xl text-accent-green mb-2"
          >
            ~ how it works ~
          </motion.p>
          <motion.h2
          ...
          {steps.map((s, i) => (
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-3">
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-ink text-paper font-[family-name:var(--font-marker)] text-2xl border-[3px] border-ink shadow-[2px_2px_0_rgba(0,0,0,0.3)]">
                  {s.num}
                </div>
              ...
              <p className="font-[family-name:var(--font-body)] text-base text-ink-soft">
                {s.desc}
              </p>
            </motion.div>
          ))}
        ...
        >
          <p className="font-[family-name:var(--font-hand)] text-2xl text-accent-orange mb-2">
            that&apos;s literally it ↓
          </p>
