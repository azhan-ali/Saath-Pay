      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="text-center py-8">
            ...
            <h2 className="font-[family-name:var(--font-marker)] text-4xl md:text-6xl text-ink mb-4">
              Join the{" "}
              <span className="squiggle">waitlist</span>
            </h2>
            <p className="font-[family-name:var(--font-body)] text-lg text-ink-soft max-w-xl mx-auto mb-8">
            ...
            <div className="flex flex-wrap justify-center items-center gap-6 text-sm font-[family-name:var(--font-sketch)] text-ink-soft">
